...
└── OSS_Audit_Report_PraveenPB.pdf        ← Full project report (12–16 pages)
```
...
git clone https://github.com/<your-username>/oss-audit-24BCY10026.git
cd oss-audit-24BCY10026
